    ...
    <div>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="<?php echo U('/Admin/Selfcity/add');?>"><i></i><span> 新增</span></a></li> 
                        <li><a class="all" href="javascript:;" onclick="checkAll(this)"><i></i><span>全选</span></a></li>
                        <li><a class="del" style="cursor:pointer;" id="btnDelete" OnClick="return ExePostBack('Selfcity')"><i></i><span>删除</span></a></li>
                    </ul>                   
                </div>
                <div class="r-list">
        ...
        <!--列表-->
		 ...
		 <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
					...
					<td align="center">
						<div class="btn-tools">
							<a title="<?php if($val[isred] == 2): ?>取消推荐<?php else: ?>设置推荐<?php endif; ?>" Class="<?php if($val[isred] == 2): ?>red selected<?php else: ?>red<?php endif; ?>" href="/Admin/Selfcity/state/id/<?php echo ($val["id"]); ?>/isred/<?php if($val[isred] == 2): ?>1<?php else: ?>2<?php endif; if($_GET[p]): ?>/p/<?php echo ($_GET['p']); endif; if($_GET[verify]): ?>/verify/<?php echo ($_GET['verify']); endif; if($_GET[keyword]): ?>/keyword/<?php echo ($_GET['keyword']); endif; ?>"></a>
						</div>
					</td>
                    <td align="center">
                        <a href="/Admin/Selfcity/edit/id/<?php echo ($val["id"]); ?>">查看/修改</a>
                    </td>
