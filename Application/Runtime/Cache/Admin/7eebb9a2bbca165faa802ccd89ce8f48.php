  ...
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
		...
		<li><a href="javascript:;" onclick="tabs(this);">基本配置</a></li>
      </ul>
    </div>
  </div>
</div>
...
<!--
  <dl>
    <dt>基本配置</dt>
    <dd>
      <dd><input type="text" name="zong" value="<?php echo ($zong); ?>" datatype="n1-2" Class="input small"  sucmsg=" " errormsg="范围0-99" value="0" /> <span class="Validform_checktip">*0-99之间的数字</span></dd>
    </dd>
  </dl>
  -->
  <dl>
    <dt>禁用词组</dt>
    <dd>
      <textarea id="webcopyright" name="ban" Class="input" /><?php echo ($ban); ?></textarea>
      <span class="Validform_checktip">词组之间用英文逗号（,）隔开</span>
    </dd>
  </dl>
</div>
