...
<div class="location">
  ...
  <i class="arrow"></i>
  <a href="/Admin/Selfcity"><span>城市列表</span></a>
  <i class="arrow"></i>
  <span>修改信息</span>
</div>
...
<div class="tab-content">
	...
	<dl>
	<dt>城市名称</dt>
		<dd><input type="text" name="title" value="<?php echo ($title); ?>" datatype="*" Class="input normal" sucmsg=" " /> <span class="Validform_checktip">*</span></dd>
	</dl> 
	<dl>
	<dt>索引前缀</dt>
		<dd><input type="text" name="prefix" value="<?php echo ($prefix); ?>" datatype="*" Class="input normal" sucmsg=" " /> <span class="Validform_checktip">*A-Z英文字母</span></dd>
	</dl>
	  <dl>
	    <dt>是否热门</dt>
	    <dd>
