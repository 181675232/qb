...
<div class="location">
  ...
  <i class="arrow"></i>
  <a href="/Admin/Group"><span>分类列表</span></a>
  <i class="arrow"></i>
  <span>修改</span>
</div>
...
<div class="tab-content">
    ...
    <dd>
      <div class="rule-single-select">
      	...
      	<select name="pid" id="ddlParentId">
      		<?php if(empty($bid)): ?><option value="0" selected="selected">无父级分类</option>
      			<?php else: ?>
				<option value="0">无父级分类</option><?php endif; ?>	
  ...
  <dl>
    <dt>分类名称</dt>
      <dd><input type="text" name="title" datatype="*" Class="input normal" sucmsg=" " value="<?php echo ($title); ?>" nullmsg="请输入导航名称！" /> <span class="Validform_checktip">*</span></dd>
  </dl> 
  <dl>
    <dt>排序</dt>
      <dd><input type="text" name="ord" Class="input small" datatype="n" sucmsg=" "  value="<?php echo ($ord); ?>" /><span class="Validform_checktip">*数字，越小越向前</span></dd>
  </dl>
</div>
<!--工具栏-->
