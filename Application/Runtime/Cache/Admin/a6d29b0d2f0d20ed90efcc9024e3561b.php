...
<div class="tab-content">
  ...
  <dl>
    <dt>用户名</dt>
      <dd><input type="text" name="username" value="<?php echo ($username); ?>"  Class="input normal" datatype="*" sucmsg=" " nullmsg="请输入用户名！" /> <span class="Validform_checktip">*</span></dd>
  </dl> 
  <dl>
    <dt>性别</dt>
    <dd>
...
<div class="tab-content" style="display: none;">
  <dl>
    <dt>帮币余额</dt>
    <dd>
      <input name="money" type="text" value="<?php echo ($money); ?>" id="txtAmount" class="input small" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">
      <span class="Validform_checktip">*账户上的帮币</span>
    </dd>
  </dl>
  <dl>
    <dt>支付宝</dt>
    <dd>
      <input name="alipay" type="text" value="<?php echo ($alipay); ?>" class="input normal"> 
    </dd>
  </dl>
  <dl>
    <dt>银行卡号</dt>
    <dd>
      <input name="banknum" type="text" value="<?php echo ($banknum); ?>" class="input normal"> 
    </dd>
  </dl>
  <dl>
    <dt>开户行</dt>
    <dd>
      <input name="bank" type="text" value="<?php echo ($bank); ?>" class="input normal"> 
    </dd>
  </dl>
  <dl>
    <dt>开户人姓名</dt>
    <dd>
      <input name="name" type="text" value="<?php echo ($name); ?>" class="input normal"> 
    </dd>
  </dl>
  <dl>
    <dt>银行预留手机</dt>
    <dd>
      <input name="moblie" type="text" value="<?php echo ($moblie); ?>" class="input normal"> 
    </dd>
  </dl>
  <!--
  <dl>
