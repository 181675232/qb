		...
		<tr>
			...
			<?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val1): $mod = ($i % 2 );++$i;?><tr>
				    ...
				    <td  style="white-space:nowrap;word-break:break-all;overflow:hidden;">
				      ...
				      <a href="/Admin/Group/edit/id/<?php echo ($val1["id"]); ?>"><?php echo ($val1["title"]); ?></a>
					  	<?php if(empty($val1["url"])): else: ?>
							(链接：<?php echo ($val1["url"]); ?>)<?php endif; ?>
					  
				    </td>
					<td align="center"><input name="ord" value="<?php echo ($val1["ord"]); ?>" Class="sort" style="text-align:center;" onblur="order(<?php echo ($val1["id"]); ?>,this.value,'Group')" /></td>
		            <td align="center">
						　<a href="/Admin/Group/add/id/<?php echo ($val1["id"]); ?>">添加标签 </a> 
							<a href="/Admin/Group/edit/id/<?php echo ($val1["id"]); ?>"> 查看/修改</a>
		            </td>
				  </tr>
